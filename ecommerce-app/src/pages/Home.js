...
//       });
//       setProducts(response.data.products);
//       setTotalPages(Math.ceil(3000 / itemsPerPage)); // Assuming API provides total products count
//     } catch (error) {
//       console.error("Error fetching products:", error);
//     }
//   };
...
//   useEffect(() => {
//     if (auth.isAuthenticated) {
//       fetchProducts(currentPage); // Fetch products whenever the current page changes
//     }
